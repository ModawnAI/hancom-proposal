...
const brands = [
  // === Greek Mythology ===
  {
    ...
    color: "#1A237E",
    mythology: "그리스",
    meaning: "신들의 왕, 천둥과 번개 — 전체 AI 시스템을 통합 지휘하는 범용 AI 플랫폼",
    files: ["zeus-text.png", "zeus-symbol.png"],
    labels: ["텍스트", "심볼"],
  },
  {
    name: "Morpheus",
  ...
  },
  {
    ...
    color: "#8B0000",
    mythology: "그리스",
    meaning: "전쟁의 신 — 공격적 최적화·경쟁 전략·레드팀 AI",
    files: ["ares-text.png", "ares-symbol.png"],
    labels: ["텍스트", "심볼"],
  },
  {
    name: "Poseidon",
    ...
    color: "#005577",
    mythology: "그리스",
    meaning: "바다의 지배자 — 대규모 데이터 스트림 처리·분산 컴퓨팅 AI",
    files: ["poseidon-text.png", "poseidon-symbol.png"],
    labels: ["텍스트", "심볼"],
  },
  {
    name: "Hercules",
    ...
    color: "#8B6914",
    mythology: "그리스",
    meaning: "12가지 과업을 완수한 최강의 영웅 — 초고성능 컴퓨팅·난제 해결 AI",
    files: ["hercules-text.png", "hercules-symbol.png"],
    labels: ["텍스트", "심볼"],
  },
  // === Celtic Mythology ===
  {
