...
**2월**, MVP 개발입니다. / 화려함보다는 **'정확한 만세력'**과 **'매력적인 코치'**의 페르소나 완성에 집중합니다.

**3월**, 1차 출시. / 웹 버전을 먼저 오픈하여 / 시장의 데이터를 흡수합니다.

**4월**, 모바일 앱 출시. / 웹에서 검증된 서비스를 / 앱으로 확장합니다.
...
2027년, 스마트 글래스가 대중화가 시작되고 메타버스 세대가 성인이 되는 시점, / 모바일 화면 속의 운세는 **낡은 것**이 됩니다.
DITTO는 그때를 위해 / 처음부터 **3D 데이터**를 기반으로 설계하려고 합니다.
